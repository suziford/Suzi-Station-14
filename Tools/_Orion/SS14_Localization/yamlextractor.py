...
######################################### Class definitions ############################################################
class YAMLExtractor:
    def __init__(self, yaml_files, project: Project, formatter: FluentFormatter):
    ...
    def execute(self):
        for yaml_file in self.yaml_files:
            ...
            pretty_fluent_file_serialized = self.formatter.format_serialized_file_data(fluent_file_serialized)

            relative_parent_dir = yaml_file.get_relative_parent_dir(self.project.prototypes_dir_path)
    ...
    def create_en_fluent_file(self, relative_parent_dir, file_name, file_data):
        en_new_dir_path = self.project.get_locale_prototypes_dir('en-US', relative_parent_dir)
...
YAMLExtractor(yaml_files=yaml_files, project=project, formatter=formatter).execute()
